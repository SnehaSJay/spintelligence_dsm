...
import { fetchSpinningCountOptions } from "@/apis/spinning";

const useSpinningCountOptions = (screen = "master") => {
  ...
  useEffect(() => {
    ...
    const loadCounts = async () => {
      ...
      try {
        const options = await fetchSpinningCountOptions({ screen });
        if (!active) return;
...
export default useSpinningCountOptions;
