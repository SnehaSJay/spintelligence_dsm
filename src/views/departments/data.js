export const departmentDirectory = [
    {
        ...
        subDepartments: [
            ...
            { slug: "comber", name: "Comber", href: "/comber", enabled: true },
            {
                slug: "draw-frame",
                name: "Draw Frame",
                breadcrumbName: "Draw Frame Notebook QC",
                pageTitle: "Quality Control - Draw Frame Notebook",
                pageDescription: "Record and manage industrial machine quality inspections.",
                href: "/draw-frame",
                enabled: true,
            },
